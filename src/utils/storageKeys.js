...
export const STORAGE_KEYS = {
  MONEY: 'dorm_money_v4',
  DICTIONARY: 'dorm_dict_v4',
  INVENTORY: 'dorm_inv_v4',
  LOGS: 'dorm_logs_v4',
  TODOS: 'dorm_todos_v1',
  EXAMS: 'dorm_exams_v1',
  SLEEP: 'dorm_sleep_v1',
  MEDICINE: 'dorm_medicine_v1',
  GRADES: 'dorm_grades_v1',
  DASHBOARD_LAYOUT: 'dorm_dashboard_layout_v1',
  SETTINGS: 'dorm_settings_v1',
};
